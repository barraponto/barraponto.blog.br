 ...
 */
function barrablog_form_install_configure_form_alter(&$form, $form_state) {
  // Hide some messages from various modules that are just too chatty.
  drupal_get_messages('status');
  drupal_get_messages('warning');

  // Set reasonable defaults for site configuration form
  $form['site_information']['site_name']['#default_value'] = 'barraponto.blog.br';
 ...
 */
function barrablog_install_tasks(&$install_state) {
  $tasks = array();
 ...
 */
function barrablog_install_tasks_alter(&$tasks, $install_state) {
 ...
 * Implements hook_form_FORM_ID_alter()
 */
function barrablog_form_apps_profile_apps_select_form_alter(&$form, $form_state) {
